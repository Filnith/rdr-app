...
const SUBSTANCES = [
  ...
  },
  {
    ...
    minIntervalMin: 240,
    conseilRedose: 'Une reprise ("booster") est déconseillée. Si elle a lieu : jamais avant 2h, dose ≤ à la moitié de la première prise, une seule fois maximum. Pas plus d\'une prise complète tous les 4-6 mois pour limiter la neurotoxicité.',
